...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_9_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.9 - Correccion de Errores Tecnicos FUR 20
echo ================================================================
echo.
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_9_%RANDOM%"
...
echo.
echo [4/10] Instalando Correccion de Errores Tecnicos FUR 20 y consolidado previo...
...
if exist "%INSTALLER_DIR%README_V5_18_9_CORRECCION_ERRORES_TECNICOS.md" copy /Y "%INSTALLER_DIR%README_V5_18_9_CORRECCION_ERRORES_TECNICOS.md" "%TARGET%README_V5_18_9_CORRECCION_ERRORES_TECNICOS.md" >nul

echo.
echo [5/10] Verificando marcadores de instalacion...
findstr /C:"FICHA_20_V5_18_9_ROUTE_MARKER" "%TARGET%src\components\ServiceDetailPage.tsx" >nul || (echo ERROR: No se encontro el marcador de ruta FUR 20. & pause & exit /b 1)
findstr /C:"TECHNICAL_ERRORS_CORRECTION_REDESIGN_V5_18_9" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul || (echo ERROR: No se encontro el redisenio FUR 20. & pause & exit /b 1)
...
echo.
echo ================================================================
echo  Instalacion v5.18.9 completada correctamente. FUR 20 instalado.
echo ================================================================
echo Valida esta ruta:
echo http://127.0.0.1:3000/#/servicios/fur-s-st-005
echo.
