...
color 0A
title SEO LOCAL v5.28.8 - Corregir estado agencias top

echo ================================================================
echo SEO LOCAL v5.28.8 - Corregir estado agencias top
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_28_8_corregir_estado_agencias_top.log"

echo SEO LOCAL v5.28.8 - %DATE% %TIME%> "%LOG%"
...
if not exist "%PROJECT_DIR%\_backup_v5_28_8" mkdir "%PROJECT_DIR%\_backup_v5_28_8" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\components\DashboardPage.tsx" "%PROJECT_DIR%\_backup_v5_28_8\DashboardPage.tsx.bak" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\services\adminApi.ts" "%PROJECT_DIR%\_backup_v5_28_8\adminApi.ts.bak" >nul 2>&1

echo [3/6] Instalando correccion visual...
...
echo.
echo ================================================================
echo Estado visual de agencias corregido correctamente.
echo ================================================================
echo.
...
echo.
echo Resultado:
echo   Verde / published = Activo
echo   Amarillo / review = En pausa
echo   Rojo / suspended = Oculto
echo.
echo Log:
echo   %LOG%
pause
