...
color 0A
title SEO LOCAL v5.22.9 - Full Width + Info/GBP 50-50

echo ================================================================
echo SEO LOCAL v5.22.9 - Full Width + Info/GBP 50-50
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_22_9_full_width_info_gbp_50_50.log"

echo SEO LOCAL v5.22.9 - %DATE% %TIME%> "%LOG%"
...
if not exist "%PROJECT_DIR%\_backup_v5_22_9" mkdir "%PROJECT_DIR%\_backup_v5_22_9" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\components\AgencyProfilePage.tsx" "%PROJECT_DIR%\_backup_v5_22_9\AgencyProfilePage.tsx.bak" >nul

echo [2/6] Copiando componente corregido...
