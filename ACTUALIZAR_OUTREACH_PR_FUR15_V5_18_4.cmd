...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_4_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.4 - Redisenio Outreach y PR Local FUR 15
echo ================================================================
echo.
...
if not exist "%PAYLOAD%\src\components\ServiceDetailPage.tsx.txt" (
  ...
  echo Verifica que el ZIP fue extraido completo y que existe _seo_local_v5_18_4_payload.
  pause
  exit /b 1
)
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_4_%RANDOM%"
...
echo.
echo [4/10] Instalando redisenio funcional FUR 15 y consolidado FUR 13-16...
...
if exist "%INSTALLER_DIR%README_V5_18_4_OUTREACH_PR_LOCAL_CORREGIDO.md" copy /Y "%INSTALLER_DIR%README_V5_18_4_OUTREACH_PR_LOCAL_CORREGIDO.md" "%TARGET%README_V5_18_4_OUTREACH_PR_LOCAL_CORREGIDO.md" >nul
...
echo.
echo ================================================================
echo  Instalacion v5.18.4 completada correctamente. Outreach y PR Local FUR 15 redisenado.
echo ================================================================
