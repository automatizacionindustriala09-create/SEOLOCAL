...
color 0A
title SEO LOCAL v5.29.4 - Limpieza segura sin parametros

echo ================================================================
echo SEO LOCAL v5.29.4 - Limpieza segura sin parametros
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_29_4_limpieza_segura.log"
set "PS1_FILE=%SCRIPT_DIR%limpieza_segura_v5294.ps1"

echo SEO LOCAL v5.29.4 - %DATE% %TIME%> "%LOG%"
...
REM Quitar barra final para evitar que PowerShell rompa argumentos.
...
if not exist "%PROJECT_DIR%\MANIFIESTO_LIMPIEZA_V5_29_4.md" (
...
echo.
echo Revisa:
echo   %PROJECT_DIR%\MANIFIESTO_LIMPIEZA_V5_29_4.md
echo.
echo Log:
echo   %LOG%
echo.
