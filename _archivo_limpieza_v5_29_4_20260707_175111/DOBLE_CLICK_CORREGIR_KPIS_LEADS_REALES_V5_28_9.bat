...
color 0A
title SEO LOCAL v5.28.9 - Corregir KPIs Leads reales

echo ================================================================
echo SEO LOCAL v5.28.9 - Corregir KPIs Leads reales
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_28_9_corregir_kpis_leads_reales.log"

echo SEO LOCAL v5.28.9 - %DATE% %TIME%> "%LOG%"
...
if not exist "%PROJECT_DIR%\_backup_v5_28_9" mkdir "%PROJECT_DIR%\_backup_v5_28_9" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\components\DashboardPage.tsx" "%PROJECT_DIR%\_backup_v5_28_9\DashboardPage.tsx.bak" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\services\adminApi.ts" "%PROJECT_DIR%\_backup_v5_28_9\adminApi.ts.bak" >nul 2>&1

echo [3/6] Instalando correccion de KPIs reales...
...
echo.
echo ================================================================
echo KPIs de Leads reales corregidos correctamente.
echo ================================================================
echo.
...
echo   Si Leads y cotizaciones esta en 0, Rendimiento comercial tambien mostrara 0.
echo.
echo Log:
echo   %LOG%
pause
