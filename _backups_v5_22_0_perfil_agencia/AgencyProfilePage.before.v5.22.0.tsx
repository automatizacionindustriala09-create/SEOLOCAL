// AGENCY_PROFILE_PAGE_V5_21_4_NAP_INFO_SIMPLIFIED_MARKER
  ...
  return (
    <section className="bg-[#f5f5f5] min-h-screen pb-28 overflow-x-hidden">
      <div className="w-full mx-0 px-0 pt-0">
        <button type="button" onClick={onBackToDirectory} className="m-3 sm:m-4 lg:m-5 inline-flex items-center gap-2 text-xs font-black uppercase tracking-wider text-gray-500 hover:text-[#D32323] transition-all">
          ...
          <div className="relative px-6 sm:px-8 pb-7 pt-7 sm:pt-6">
            <div className="sm:flex sm:items-start sm:justify-between gap-6">
              <div className="flex items-start gap-4 relative z-10 min-w-0">
                <div className={`shrink-0 -mt-16 sm:-mt-14 w-28 h-28 sm:w-32 sm:h-32 rounded-3xl ${currentAgency.logoBgColor} text-white flex items-center justify-center text-5xl font-black shadow-2xl ring-8 ring-white`}>
                  {currentAgency.logoLetter}
                </div>
                <div className="min-w-0 pt-8 sm:pt-7 pb-2">
                  ...
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3 max-w-4xl w-full" aria-label="NAP de la agencia">
                    <div className="rounded-2xl border border-gray-200 bg-white/95 px-4 py-3 shadow-sm flex items-start gap-3">
                      <span className="w-9 h-9 rounded-xl bg-red-50 text-[#D32323] flex items-center justify-center shrink-0"><BadgeCheck className="w-4 h-4" /></span>
                      <div className="min-w-0">
                        <p className="text-[9px] font-black uppercase tracking-wider text-gray-400">Name / Nombre</p>
                        <p className="mt-1 text-xs sm:text-sm font-black text-[#333] leading-snug truncate">{currentAgency.name}</p>
                      </div>
                    </div>
                    <div className="rounded-2xl border border-gray-200 bg-white/95 px-4 py-3 shadow-sm flex items-start gap-3">
                      <span className="w-9 h-9 rounded-xl bg-blue-50 text-[#0074E0] flex items-center justify-center shrink-0"><MapPin className="w-4 h-4" /></span>
                      <div className="min-w-0">
                        <p className="text-[9px] font-black uppercase tracking-wider text-gray-400">Address / Dirección</p>
                        <p className="mt-1 text-xs sm:text-sm font-black text-[#333] leading-snug">{agencyAddress(currentAgency)}</p>
                      </div>
                    </div>
                    <a href={`tel:${currentAgency.phone}`} className="rounded-2xl border border-gray-200 bg-white/95 hover:border-[#D32323]/50 px-4 py-3 shadow-sm flex items-start gap-3 transition-all">
                      <span className="w-9 h-9 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0"><Phone className="w-4 h-4" /></span>
                      <div className="min-w-0">
                        <p className="text-[9px] font-black uppercase tracking-wider text-gray-400">Phone / Teléfono</p>
                        <p className="mt-1 text-xs sm:text-sm font-black text-[#333] leading-snug truncate">{currentAgency.phone || 'Teléfono pendiente'}</p>
                      </div>
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-6 sm:mt-2 flex sm:flex-col gap-2 min-w-[190px] shrink-0">
