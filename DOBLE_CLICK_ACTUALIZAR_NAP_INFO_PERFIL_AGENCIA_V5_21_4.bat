...
title SEO LOCAL v5.21.4 - NAP e informacion simple perfil agencia

echo ================================================================
echo SEO LOCAL v5.21.4 - NAP e informacion simple en perfil agencia
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
if "%SCRIPT_DIR:~-1%"=="\" set "SCRIPT_DIR=%SCRIPT_DIR:~0,-1%"
set "PAYLOAD_DIR=%SCRIPT_DIR%\_seo_local_v5_21_4_payload"
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_21_4_nap_info_perfil_agencia.log"

echo SEO LOCAL v5.21.4 - %DATE% %TIME%> "%LOG%"
...
if not defined PROJECT_DIR (
  ...
  echo Debe existir package.json y src\components\AgencyProfilePage.tsx.
...
if not exist "%PAYLOAD_DIR%\apply_v5214_nap_info.cjs" (
  echo ERROR: No existe el payload de actualizacion.
  echo Falta: %PAYLOAD_DIR%\apply_v5214_nap_info.cjs
  echo ERROR: payload faltante>> "%LOG%"
  goto :FAIL
)

echo [2/6] Aplicando NAP e informacion simple al perfil individual...
node "%PAYLOAD_DIR%\apply_v5214_nap_info.cjs" "%PROJECT_DIR%" >> "%LOG%" 2>&1
if errorlevel 1 (
...
echo.
echo ================================================================
echo Actualizacion v5.21.4 completada correctamente.
echo ================================================================
echo.
...
echo   - Informacion General ahora es un texto largo y simple por agencia.
echo   - Se eliminaron las subdivisiones internas de ese modulo.
echo   - Se elimino el modulo lateral Datos de contacto directo.
echo   - NAP visible junto al logo/nombre: Name, Address y Phone.
echo.
echo Log:
echo   %LOG%
echo.
...
echo.
echo ================================================================
echo ERROR: No se pudo completar la actualizacion v5.21.4.
echo ================================================================
echo Revisa el log:
echo   %LOG%
echo.
