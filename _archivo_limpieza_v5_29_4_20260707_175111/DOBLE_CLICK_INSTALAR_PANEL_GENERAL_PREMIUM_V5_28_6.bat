...
color 0A
title SEO LOCAL v5.28.6 - Panel General Premium

echo ================================================================
echo SEO LOCAL v5.28.6 - Panel General Premium
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_28_6_panel_general_premium.log"

echo SEO LOCAL v5.28.6 - %DATE% %TIME%> "%LOG%"
...
if not exist "%PROJECT_DIR%\_backup_v5_28_6" mkdir "%PROJECT_DIR%\_backup_v5_28_6" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\components\DashboardPage.tsx" "%PROJECT_DIR%\_backup_v5_28_6\DashboardPage.tsx.bak" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\services\adminApi.ts" "%PROJECT_DIR%\_backup_v5_28_6\adminApi.ts.bak" >nul 2>&1

echo [3/6] Instalando Panel General Premium...
...
echo.
echo ================================================================
echo Panel General Premium instalado correctamente.
echo ================================================================
echo.
