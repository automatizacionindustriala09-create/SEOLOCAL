...
color 0A
title SEO LOCAL v5.27.1 - Reparar Leads y Cotizaciones

echo ================================================================
echo SEO LOCAL v5.27.1 - Reparar Leads y Cotizaciones
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_27_1_reparar_leads_cotizaciones.log"

echo SEO LOCAL v5.27.1 - %DATE% %TIME%> "%LOG%"
...
echo [2/6] Copiando migracion correctiva...
if not exist "%PROJECT_DIR%\backend\migrations" mkdir "%PROJECT_DIR%\backend\migrations" >nul 2>&1
copy /Y "%SCRIPT_DIR%payload\backend\migrations\022_fix_dashboard_leads_agency_partner.sql" "%PROJECT_DIR%\backend\migrations\022_fix_dashboard_leads_agency_partner.sql" >nul
if errorlevel 1 (
  echo ERROR: No pude copiar la migracion.
  echo Error copiando migracion>> "%LOG%"
  pause
  exit /b 1
)
...
echo [5/6] Reiniciando API para aplicar migracion 022...
...
echo.
echo ================================================================
echo Leads y Cotizaciones reparado correctamente.
echo ================================================================
echo.
