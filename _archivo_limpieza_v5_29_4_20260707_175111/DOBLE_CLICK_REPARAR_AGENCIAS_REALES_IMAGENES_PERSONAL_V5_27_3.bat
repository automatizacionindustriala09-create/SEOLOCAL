...
color 0A
title SEO LOCAL v5.27.3 - Agencias reales, imagenes y personal

echo ================================================================
echo SEO LOCAL v5.27.3 - Agencias reales, imagenes y personal
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_27_3_agencias_reales_imagenes_personal.log"

echo SEO LOCAL v5.27.3 - %DATE% %TIME%> "%LOG%"
...
if not exist "%PROJECT_DIR%\_backup_v5_27_3" mkdir "%PROJECT_DIR%\_backup_v5_27_3" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\components\DashboardPage.tsx" "%PROJECT_DIR%\_backup_v5_27_3\DashboardPage.tsx.bak" >nul 2>&1
copy /Y "%PROJECT_DIR%\backend\src\server.js" "%PROJECT_DIR%\_backup_v5_27_3\server.js.bak" >nul 2>&1
...
node "%SCRIPT_DIR%tools\patch_agency_profile_media_v5273.cjs"
if errorlevel 1 (
