...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_2_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.2 - Rediseño Backlinks Premium FUR 13 + Fichas 13 a 16
echo ================================================================
echo.
...
if not exist "%PAYLOAD%\src\components\ServiceDetailPage.tsx.txt" (
  ...
  echo Verifica que el ZIP fue extraido completo y que existe _seo_local_v5_18_2_payload.
  pause
  exit /b 1
)
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_2_%RANDOM%"
...
if exist "%INSTALLER_DIR%README_V5_18_2_BACKLINKS_PREMIUM_CORREGIDO.md" copy /Y "%INSTALLER_DIR%README_V5_18_2_BACKLINKS_PREMIUM_CORREGIDO.md" "%TARGET%README_V5_18_2_BACKLINKS_PREMIUM_CORREGIDO.md" >nul
...
if errorlevel 1 (
  echo ERROR: No se encontro el rediseño v5.18.2 de Backlinks Premium FUR 13.
  pause
  exit /b 1
)
...
echo.
echo ================================================================
echo  Instalacion v5.18.2 completada correctamente. Backlinks Premium FUR 13 rediseñado.
echo ================================================================
