...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_3_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.3 - Redisenio Enlaces NAP FUR 14 + Fichas 13 a 16
echo ================================================================
echo.
...
if not exist "%PAYLOAD%\src\components\ServiceDetailPage.tsx.txt" (
  ...
  echo Verifica que el ZIP fue extraido completo y que existe _seo_local_v5_18_3_payload.
  pause
  exit /b 1
)
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_3_%RANDOM%"
...
echo.
echo [4/10] Instalando redisenio funcional FUR 14 y consolidado FUR 13-16...
...
if exist "%INSTALLER_DIR%README_V5_18_3_ENLACES_NAP_CORREGIDO.md" copy /Y "%INSTALLER_DIR%README_V5_18_3_ENLACES_NAP_CORREGIDO.md" "%TARGET%README_V5_18_3_ENLACES_NAP_CORREGIDO.md" >nul
...
echo.
echo ================================================================
echo  Instalacion v5.18.3 completada correctamente. Enlaces NAP FUR 14 redisenado.
echo ================================================================
