...
color 0A
title SEO LOCAL v5.26.1 - Dashboard conectado a BD

echo ================================================================
echo SEO LOCAL v5.26.1 - Dashboard conectado a BD
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_26_1_dashboard_bd.log"

echo SEO LOCAL v5.26.1 - %DATE% %TIME%> "%LOG%"
...
if not exist "%PROJECT_DIR%\_backup_v5_26_1" mkdir "%PROJECT_DIR%\_backup_v5_26_1" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\App.tsx" "%PROJECT_DIR%\_backup_v5_26_1\App.tsx.bak" >nul
copy /Y "%PROJECT_DIR%\src\components\Header.tsx" "%PROJECT_DIR%\_backup_v5_26_1\Header.tsx.bak" >nul
copy /Y "%PROJECT_DIR%\backend\src\server.js" "%PROJECT_DIR%\_backup_v5_26_1\server.js.bak" >nul
...
echo [4/9] Parcheando App, Header y API con Node...
set "SEO_PROJECT_ROOT=%PROJECT_DIR%"
set "SEO_INSTALLER_ROOT=%SCRIPT_DIR%"
set "SEO_LOG_PATH=%LOG%"
node "%SCRIPT_DIR%tools\patch_dashboard_v5261.cjs"
if errorlevel 1 (
