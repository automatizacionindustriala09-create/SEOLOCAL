...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_11_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.11 - Reparacion TypeScript / Backups
echo ================================================================
echo.
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_11_%RANDOM%"
...
echo.
echo [4/10] Reinstalando archivos consolidados y limpiando respaldos internos...
...
if exist "%INSTALLER_DIR%README_V5_18_11_BLOG_LOCAL_MENSUAL.md" copy /Y "%INSTALLER_DIR%README_V5_18_11_BLOG_LOCAL_MENSUAL.md" "%TARGET%README_V5_18_11_BLOG_LOCAL_MENSUAL.md" >nul

echo.
echo [5/10] Verificando marcadores de instalacion...
findstr /C:"FICHA_22_V5_18_11_ROUTE_MARKER" "%TARGET%src\components\ServiceDetailPage.tsx" >nul || (echo ERROR: No se encontro el marcador de ruta FUR 22. & pause & exit /b 1)
findstr /C:"BLOG_LOCAL_MONTHLY_REDESIGN_V5_18_11" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul || (echo ERROR: No se encontro el redisenio FUR 22. & pause & exit /b 1)
...
echo.
echo ================================================================
echo  Instalacion v5.18.11 completada correctamente. FUR 22 instalado.
echo ================================================================
echo Valida esta ruta:
echo http://127.0.0.1:3000/#/servicios/fur-s-ct-002
echo.
