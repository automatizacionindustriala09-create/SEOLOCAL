...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_10_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.10 - Redaccion de Contenido Local FUR 21
echo ================================================================
echo.
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_10_%RANDOM%"
...
echo.
echo [4/10] Instalando Redaccion de Contenido Local FUR 21 y consolidado previo...
...
if exist "%INSTALLER_DIR%README_V5_18_10_CONTENIDO_LOCAL.md" copy /Y "%INSTALLER_DIR%README_V5_18_10_CONTENIDO_LOCAL.md" "%TARGET%README_V5_18_10_CONTENIDO_LOCAL.md" >nul

echo.
echo [5/10] Verificando marcadores de instalacion...
findstr /C:"FICHA_21_V5_18_10_ROUTE_MARKER" "%TARGET%src\components\ServiceDetailPage.tsx" >nul || (echo ERROR: No se encontro el marcador de ruta FUR 21. & pause & exit /b 1)
findstr /C:"LOCAL_CONTENT_WRITING_REDESIGN_V5_18_10" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul || (echo ERROR: No se encontro el redisenio FUR 21. & pause & exit /b 1)
...
echo.
echo ================================================================
echo  Instalacion v5.18.10 completada correctamente. FUR 21 instalado.
echo ================================================================
echo Valida esta ruta:
echo http://127.0.0.1:3000/#/servicios/fur-s-ct-001
echo.
