...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_8_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.8 - Implementacion Schema Local FUR 19
echo ================================================================
echo.
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_8_%RANDOM%"
...
echo.
echo [4/10] Instalando Schema Local FUR 19 y consolidado previo...
...
if exist "%INSTALLER_DIR%README_V5_18_8_SCHEMA_LOCAL.md" copy /Y "%INSTALLER_DIR%README_V5_18_8_SCHEMA_LOCAL.md" "%TARGET%README_V5_18_8_SCHEMA_LOCAL.md" >nul

echo.
echo [5/10] Verificando marcadores de instalacion...
findstr /C:"FICHA_19_V5_18_8_ROUTE_MARKER" "%TARGET%src\components\ServiceDetailPage.tsx" >nul || (echo ERROR: No se encontro el marcador de ruta FUR 19. & pause & exit /b 1)
findstr /C:"SCHEMA_LOCAL_IMPLEMENTATION_REDESIGN_V5_18_8" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul || (echo ERROR: No se encontro el redisenio FUR 19. & pause & exit /b 1)
...
echo.
echo ================================================================
echo  Instalacion v5.18.8 completada correctamente. FUR 19 Schema Local instalado.
echo ================================================================
echo Valida esta ruta:
echo http://127.0.0.1:3000/#/servicios/fur-s-st-004
echo.
