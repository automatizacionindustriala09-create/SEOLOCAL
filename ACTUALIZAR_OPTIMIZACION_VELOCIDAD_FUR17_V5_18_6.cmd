...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_6_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.6 - Redisenio Optimizacion de Velocidad FUR 17
echo ================================================================
echo.
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_6_%RANDOM%"
...
echo.
echo [4/10] Instalando redisenio funcional FUR 17 y consolidado previo...
...
if exist "%INSTALLER_DIR%README_V5_18_6_OPTIMIZACION_VELOCIDAD.md" copy /Y "%INSTALLER_DIR%README_V5_18_6_OPTIMIZACION_VELOCIDAD.md" "%TARGET%README_V5_18_6_OPTIMIZACION_VELOCIDAD.md" >nul

echo.
echo [5/10] Verificando marcadores de instalacion...
findstr /C:"FICHA_17_V5_18_6_ROUTE_MARKER" "%TARGET%src\components\ServiceDetailPage.tsx" >nul || (echo ERROR: No se encontro el marcador de ruta FUR 17. & pause & exit /b 1)
findstr /C:"SPEED_OPTIMIZATION_REDESIGN_V5_18_6" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul || (echo ERROR: No se encontro el redisenio FUR 17. & pause & exit /b 1)
...
echo.
echo ================================================================
echo  Instalacion v5.18.6 completada correctamente. FUR 17 Optimización de Velocidad instalado.
echo ================================================================
echo Valida esta ruta:
echo http://127.0.0.1:3000/#/servicios/fur-s-st-002
echo.
