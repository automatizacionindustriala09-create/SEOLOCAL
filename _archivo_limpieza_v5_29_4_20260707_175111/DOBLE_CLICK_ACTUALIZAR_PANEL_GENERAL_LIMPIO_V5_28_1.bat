...
color 0A
title SEO LOCAL v5.28.1 - Panel General Ejecutivo Limpio

echo ================================================================
echo SEO LOCAL v5.28.1 - Panel General Ejecutivo Limpio
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_28_1_panel_general_limpio.log"

echo SEO LOCAL v5.28.1 - %DATE% %TIME%> "%LOG%"
...
if not exist "%PROJECT_DIR%\_backup_v5_28_1" mkdir "%PROJECT_DIR%\_backup_v5_28_1" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\components\DashboardPage.tsx" "%PROJECT_DIR%\_backup_v5_28_1\DashboardPage.tsx.bak" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\services\adminApi.ts" "%PROJECT_DIR%\_backup_v5_28_1\adminApi.ts.bak" >nul 2>&1
copy /Y "%PROJECT_DIR%\backend\src\server.js" "%PROJECT_DIR%\_backup_v5_28_1\server.js.bak" >nul 2>&1

echo [3/8] Instalando panel general limpio...
...
echo [4/8] Ajustando etiquetas del feed reciente...
set "SEO_PROJECT_ROOT=%PROJECT_DIR%"
set "SEO_LOG_PATH=%LOG%"
node "%SCRIPT_DIR%tools\patch_executive_overview_clean_v5281.cjs"
if errorlevel 1 (
...
echo.
echo ================================================================
echo Panel General Ejecutivo Limpio instalado correctamente.
echo ================================================================
echo.
