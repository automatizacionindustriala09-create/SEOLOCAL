...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_12_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.12 - Paginas de Servicio Optimizadas FUR 23
echo ================================================================
echo.
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_12_%RANDOM%"
...
echo.
echo [4/10] Instalando Paginas de Servicio Optimizadas FUR 23 y consolidado previo...
copy /Y "%PAYLOAD%\src\components\ServiceDetailPage.tsx.txt" "%TARGET%src\components\ServiceDetailPage.tsx" >nul || (echo ERROR copiando ServiceDetailPage.tsx & pause & exit /b 1)
copy /Y "%PAYLOAD%\src\components\LocalAdvancedServicePages.tsx.txt" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul || (echo ERROR copiando LocalAdvancedServicePages.tsx & pause & exit /b 1)
...
if exist "%INSTALLER_DIR%README_V5_18_12_PAGINAS_SERVICIO_OPTIMIZADAS.md" copy /Y "%INSTALLER_DIR%README_V5_18_12_PAGINAS_SERVICIO_OPTIMIZADAS.md" "%TARGET%README_V5_18_12_PAGINAS_SERVICIO_OPTIMIZADAS.md" >nul

echo.
echo [5/10] Verificando marcadores de instalacion...
findstr /C:"FICHA_23_V5_18_12_ROUTE_MARKER" "%TARGET%src\components\ServiceDetailPage.tsx" >nul || (echo ERROR: No se encontro el marcador de ruta FUR 23. & pause & exit /b 1)
findstr /C:"SERVICE_PAGES_OPTIMIZED_REDESIGN_V5_18_12" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul || (echo ERROR: No se encontro el redisenio FUR 23. & pause & exit /b 1)
findstr /C:"_backup*" "%TARGET%tsconfig.json" >nul || (echo ERROR: tsconfig.json no contiene las exclusiones de respaldos. & pause & exit /b 1)
...
echo.
echo ================================================================
echo  Instalacion v5.18.12 completada correctamente. FUR 23 instalado.
echo ================================================================
echo Valida esta ruta:
echo http://127.0.0.1:3000/#/servicios/fur-s-ct-003
echo.
