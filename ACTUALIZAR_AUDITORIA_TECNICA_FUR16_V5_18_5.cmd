...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_5_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.5 - Redisenio Auditoria Tecnica SEO Local FUR 16
echo ================================================================
echo.
...
if not exist "%PAYLOAD%\src\components\ServiceDetailPage.tsx.txt" (
  ...
  echo Verifica que el ZIP fue extraido completo y que existe _seo_local_v5_18_5_payload.
  pause
  exit /b 1
)
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_5_%RANDOM%"
...
echo.
echo [4/10] Instalando redisenio funcional FUR 16 y consolidado FUR 13-16...
...
if exist "%INSTALLER_DIR%README_V5_18_5_AUDITORIA_TECNICA_CORREGIDO.md" copy /Y "%INSTALLER_DIR%README_V5_18_5_AUDITORIA_TECNICA_CORREGIDO.md" "%TARGET%README_V5_18_5_AUDITORIA_TECNICA_CORREGIDO.md" >nul
...
findstr /C:"BACKLINKS_PREMIUM_REDESIGN_V5_18_2" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul
if errorlevel 1 (
  echo ERROR: No se encontro el redisenio v5.18.2 de Backlinks Premium FUR 13.
  pause
  exit /b 1
)
findstr /C:"NAP_LINKS_REDESIGN_V5_18_3" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul
if errorlevel 1 (
  echo ERROR: No se encontro el redisenio v5.18.3 de Enlaces NAP FUR 14.
  pause
  exit /b 1
)
findstr /C:"OUTREACH_PR_LOCAL_REDESIGN_V5_18_4" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul
if errorlevel 1 (
  echo ERROR: No se encontro el redisenio v5.18.4 de Outreach y PR Local FUR 15.
  pause
  exit /b 1
)
findstr /C:"TECHNICAL_SEO_AUDIT_REDESIGN_V5_18_5" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul
if errorlevel 1 (
  echo ERROR: No se encontro el redisenio v5.18.5 de Auditoria Tecnica SEO Local FUR 16.
  pause
  exit /b 1
)
...
echo.
echo ================================================================
echo  Instalacion v5.18.5 completada correctamente. Auditoria Tecnica SEO Local FUR 16 redisenada.
echo ================================================================
