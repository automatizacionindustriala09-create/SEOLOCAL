-- SEO LOCAL v5.28.3 — Reparación vista pública de agencias
...
SELECT NULL, 'repair', 'public_agencies_vacation_visibility_v5_28_3', NULL,
...
AND NOT EXISTS (
  SELECT 1 FROM seo_local_dashboard_audit_log WHERE model='public_agencies_vacation_visibility_v5_28_3'
);
