...
set "PAYLOAD=%INSTALLER_DIR%_seo_local_v5_18_7_payload"
set "TARGET="
set "SAFE_BACKUP_ROOT=%USERPROFILE%\Desktop\SEO_LOCAL_RESPALDOS_EXTERNOS"
set "BACKUP_DIR="

echo ================================================================
echo  SEO LOCAL v5.18.7 - Redisenio SEO On-Page Tecnico FUR 18
echo ================================================================
echo.
...
set "BACKUP_DIR=%SAFE_BACKUP_ROOT%\backup_v5_18_7_%RANDOM%"
...
echo.
echo [4/10] Instalando SEO On-Page Tecnico FUR 18 y consolidado previo...
...
if exist "%INSTALLER_DIR%README_V5_18_7_SEO_ON_PAGE_TECNICO.md" copy /Y "%INSTALLER_DIR%README_V5_18_7_SEO_ON_PAGE_TECNICO.md" "%TARGET%README_V5_18_7_SEO_ON_PAGE_TECNICO.md" >nul

echo.
echo [5/10] Verificando marcadores de instalacion...
findstr /C:"FICHA_18_V5_18_7_ROUTE_MARKER" "%TARGET%src\components\ServiceDetailPage.tsx" >nul || (echo ERROR: No se encontro el marcador de ruta FUR 18. & pause & exit /b 1)
findstr /C:"SEO_ON_PAGE_TECHNICAL_REDESIGN_V5_18_7" "%TARGET%src\components\LocalAdvancedServicePages.tsx" >nul || (echo ERROR: No se encontro el redisenio FUR 18. & pause & exit /b 1)
...
echo.
echo ================================================================
echo  Instalacion v5.18.7 completada correctamente. FUR 18 SEO On-Page Tecnico instalado.
echo ================================================================
echo Valida esta ruta:
echo http://127.0.0.1:3000/#/servicios/fur-s-st-003
echo.
