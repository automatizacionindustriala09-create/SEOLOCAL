...
color 0A
title SEO LOCAL v5.28.4 - Panel General Slider

echo ================================================================
echo SEO LOCAL v5.28.4 - Panel General Slider
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_28_4_panel_general_slider.log"

echo SEO LOCAL v5.28.4 - %DATE% %TIME%> "%LOG%"
...
if not exist "%PROJECT_DIR%\_backup_v5_28_4" mkdir "%PROJECT_DIR%\_backup_v5_28_4" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\components\DashboardPage.tsx" "%PROJECT_DIR%\_backup_v5_28_4\DashboardPage.tsx.bak" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\services\adminApi.ts" "%PROJECT_DIR%\_backup_v5_28_4\adminApi.ts.bak" >nul 2>&1

echo [3/6] Instalando panel general con slider...
...
echo.
echo ================================================================
echo Panel General Slider instalado correctamente.
echo ================================================================
echo.
