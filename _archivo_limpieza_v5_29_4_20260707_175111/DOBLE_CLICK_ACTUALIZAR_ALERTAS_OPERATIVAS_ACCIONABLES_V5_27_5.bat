...
color 0A
title SEO LOCAL v5.27.5 - Alertas operativas accionables

echo ================================================================
echo SEO LOCAL v5.27.5 - Alertas operativas accionables
echo ================================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR="
set "LOG=%USERPROFILE%\Desktop\seo_local_v5_27_5_alertas_operativas_accionables.log"

echo SEO LOCAL v5.27.5 - %DATE% %TIME%> "%LOG%"
...
echo [2/6] Respaldando DashboardPage.tsx...
if not exist "%PROJECT_DIR%\_backup_v5_27_5" mkdir "%PROJECT_DIR%\_backup_v5_27_5" >nul 2>&1
copy /Y "%PROJECT_DIR%\src\components\DashboardPage.tsx" "%PROJECT_DIR%\_backup_v5_27_5\DashboardPage.tsx.bak" >nul 2>&1

echo [3/6] Instalando dashboard con alertas accionables...
...
echo.
echo ================================================================
echo Alertas operativas accionables instaladas correctamente.
echo ================================================================
echo.
echo Abre con Ctrl + F5:
echo   http://127.0.0.1:3000/#/dashboard
echo.
echo Las alertas con valor mayor a 0 ahora se pueden presionar.
echo.
echo Log:
echo   %LOG%
pause
